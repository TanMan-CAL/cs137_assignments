...
// and doesn’t have an active loan already. 
// If the amount is less than the maximum loan to be given by the bank, increase the balance of the account by amount
